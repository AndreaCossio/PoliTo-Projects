            ...
            echo "<div class=\"col-md-12 src-tab\">
              ...
              <div class=\"src-tab-right\">
                <div class=\"src-tab-head row\">
                  <div class=\"col-md-10\"><a href=\"view.php?id=$row[Id]\"><h3>$row[Title]</h3></a></div>
                  <div class=\"col-md-2\"><h3><i class=\"fa fa-thumbs-up\"></i> $votes</h3></div>
                </div>
                <hr>
                <div class=\"src-tab-info row\">
                  <div class=\"col-md-6\"><i class=\"fa fa-user\"></i> $row[User]</div>
                  <div class=\"col-md-6\"><i class=\"fa fa-calendar\"></i> $row[Date]</div>
                </div>
                <div class=\"src-tab-info row\">
                  <div class=\"col-md-6\"><i class=\"fa fa-building\"></i> $row[Company]</div>
                  <div class=\"col-md-6\"><i class=\"fa fa-briefcase\"></i> $row[Position]</div>
                </div>
              </div>
            </div>";
          }
